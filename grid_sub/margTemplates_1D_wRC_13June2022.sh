...
#export SINGULARITY_BINDPATH="${path}/P-theta/Minimal/NOvA_files/jf_data_asimov4_fake:/jf_data"
echo "SINGULARITY_TMPDIR: ${SINGULARITY_TMPDIR} : ${SINGULARITY_BINDPATH}"
...
#cp $path/nova-sl7-novat2k_v4_fixcosmicsrock.tar.bz2 ./
#ls 
#tar -xf nova-sl7-novat2k_v4_fixcosmicsrock.tar.bz2
#echo "untar of sandbox is done..!"

#ln -sf $path/P-theta/Minimal/NOvA_files/jf_data_asimov1_fake/data_nova2020ana_fake_asimov1.root $path/P-theta/Minimal/NOvA_files/jf_data_asimov1_fake/data.container.root #Asimov1, T2K best-fit point
...
singularity exec -B ${path}/P-theta/Minimal/NOvA_files/jf_mc:/jf_mc -B ${path}/P-theta/Minimal/NOvA_files/jf_data_asimov4_fake:/jf_data ${path}/nova-sl7-novat2k_v4_fixcosmicsrock ls /jf_data
