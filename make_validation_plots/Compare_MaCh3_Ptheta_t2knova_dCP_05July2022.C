...
void Compare_MaCh3_Ptheta_t2knova_dCP_05July2022(const char* expt, const char* osc_par) {
	...
	hmdchi2_no->GetXaxis()->SetTitle("#delta_{CP}");
	...
	hmdchi2_io->GetXaxis()->SetTitle("#delta_{CP}");
