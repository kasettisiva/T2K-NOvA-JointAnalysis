...
void Compare_MaCh3_Ptheta_Aria_t2knova_19July2022(const char* expt, const char* osc_par, const char* outstring) {
    ...
    (strstr(osc_par,"th23") != NULL)?hadchi2_no->GetYaxis()->SetRangeUser(0,25):hadchi2_no->GetYaxis()->SetRangeUser(0,30);
