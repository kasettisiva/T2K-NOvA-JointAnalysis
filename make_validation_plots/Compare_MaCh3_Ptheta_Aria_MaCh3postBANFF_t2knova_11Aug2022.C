...
void GetRatioHist(TH1* hp, TH1* hm, TH1* ha, TH1* hmb, TLegend *leg, Binning binning, bool isDchi2, const char* output_name) {
...
void Compare_MaCh3_Ptheta_Aria_MaCh3postBANFF_t2knova_11Aug2022(const char* expt, const char* osc_par, const char* outstring) {
...
//    (strstr(osc_par,"th23") != NULL)?hmbanff_io->GetYaxis()->SetRangeUser(0,0.04):hmbanff_io->GetYaxis()->SetRangeUser(0,0.1);
    ...
    GetRatioHist(hpdchi2_no, hmdchi2_no, hadchi2_no, hmbanffdchi2_no, leg, binning, ((strstr(osc_par,"th23") != NULL)?true:false), Form("compare_dchi2_mach3_ptheta_aria_mach3postbanff_%s_NO_%s_%s.pdf",osc_par,expt,outstring));
    ...
    GetRatioHist(hpdchi2_io, hmdchi2_io, hadchi2_io, hmbanffdchi2_io, leg, binning, ((strstr(osc_par,"th23") != NULL)?true:false), Form("compare_dchi2_mach3_ptheta_aria_mach3postbanff_%s_IO_%s_%s.pdf",osc_par,expt,outstring));
