...
void Compare_MaCh3_Ptheta_Aria_t2knova_dm2_21Aug2022(const char* expt, const char* osc_par, const char* outstring) {
    ...
    htemp_no->Scale(1/totalbc);
    htemp_io->Scale(1/totalbc);
