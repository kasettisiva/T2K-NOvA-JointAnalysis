...
Binning dm2_both_binning = {1000, -3.0e-3, 3.0e-3};
Binning th23_binning = {81,0.38,0.62};
Binning binning;
Binning binning_io;
Binning binning_both;

void Compare_MaCh3_Ptheta_Aria_t2knova_dm2_11Aug2022(const char* expt, const char* osc_par, const char* outstring) {
	...
	TH1D* hm=new TH1D("hm","hm",           binning_both.nbins, binning_both.bin_min, binning_both.bin_max);
	...
	hm_no->Scale(1/hm->Integral()); //normalize
	hm_io->Scale(1/hm->Integral()); //normalize
	...
	ha_no->Scale(1/ha->Integral()); //normalize
	ha_io->Scale(1/ha->Integral()); //normalize
	...
	hm_iozoom->GetXaxis()->SetMaxDigits(2);
	hm_iozoom->SetTitle("NO");
	hm_iozoom->GetYaxis()->SetTitle("Posterior probability");
	//hm_iozoom->GetXaxis()->SetTitle("#Delta m^{2}_{32}");
	hm_iozoom->GetYaxis()->SetTitleSize(0.05);
	hm_iozoom->GetYaxis()->SetLabelSize(0.05);
	hm_iozoom->GetXaxis()->SetLabelSize(0.05);
	...
	hm->SetTitle("IO");
	hm->GetXaxis()->SetTitle("#Delta m^{2}_{32}");
	hm->GetXaxis()->SetTitleSize(0.05);
	hm->GetXaxis()->SetTitleOffset(0.90);
	hm->GetYaxis()->SetLabelSize(0);
	hm->GetXaxis()->SetLabelSize(0.05);
	hm->GetXaxis()->SetMaxDigits(2);
