...
void Compare_MaCh3_Ptheta_Aria_t2knova_dCP_07July2022(const char* expt, const char* osc_par, const char* outstring) {
	...
	hm->GetXaxis()->SetTitle("#delta_{CP}");
	...
	hm_no->GetXaxis()->SetTitle("#delta_{CP}");
	...
	hm_io->GetXaxis()->SetTitle("#delta_{CP}");
	...
	hadchi2_no->GetXaxis()->SetTitle("#delta_{CP}");
	...
	hadchi2_io->GetXaxis()->SetTitle("#delta_{CP}");
